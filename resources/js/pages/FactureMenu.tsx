...
export default function FactureMenu() {
    return (
        <AppLayout>
            <Head title="Menu des factures" />

            {/* Arrière-plan de page uniforme */}
            <div className="min-h-screen bg-gray-100 py-12">
                <div className="mx-auto w-full sm:px-6 lg:px-8">
                    <div className="overflow-hidden rounded-xl bg-white p-8 shadow-lg">
                        <h1 className="mb-10 text-center text-3xl font-extrabold text-gray-900">Sélectionner un type de facture</h1>

                        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                            {/* Carte pour les factures de Laptops */}
                            <Link
                            ...
                            >
                                ...
                                <h2 className="mb-2 text-2xl font-bold">Factures Laptops</h2>
                                <p className="text-lg opacity-90">Gérer les factures pour les ordinateurs portables.</p>
                            </Link>

                            {/* Carte pour les factures d'Articles */}
                            <Link
                            ...
                            >
                                ...
                                <h2 className="mb-2 text-2xl font-bold">Factures Articles</h2>
                                <p className="text-lg opacity-90">Gérer les factures pour les articles.</p>
                            </Link>

                            {/* Carte pour les factures de Réparations */}
                            <Link
                            ...
                            >
                                ...
                                <h2 className="mb-2 text-2xl font-bold">Factures Réparations</h2>
                                <p className="text-lg opacity-90">Gérer les factures pour les réparations.</p>
                            </Link>
                        </div>
                    </div>
                </div>
