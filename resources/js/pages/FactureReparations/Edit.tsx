...
// Define the FactureReparation interface for the data passed to the Edit component
interface FactureReparation {
    ...
    id_repar: string; // The ID of the associated reparation
...
export default function Edit({ facture, clients, reparations }: EditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('facture-reparations.update', facture.id_facture_repar));
    };
