...
// Define the LaptopForm interface for the form data, without etat_lap
...
export default function Create({ fournisseurs }: CreateProps) {
    const { data, setData, post, processing, errors } = useForm<LaptopForm>({
        nom_lap: '',
        marque_lap: '',
        prix_achat_lap: '',
        prix_vente_lap: '',
        date_achat_lap: '',
        quantite_lap: '1', // Default quantity to 1
        desc_lap: '',
